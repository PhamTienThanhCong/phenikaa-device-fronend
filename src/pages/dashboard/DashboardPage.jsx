...
const DashboardPage = () => {
  ...
  const list = [
    {
      img: ava1,
      Title: "ĐINH VĂN THỨC",
      bud: "17/06/2024 07:00 ~ 17/07/2024 07:00",
      // progress: <Progress percent={60} size="small" />,
      member: (
        <div className="avatar-group mt-2">
          <Tooltip placement="bottom" title="Máy tính">
            <img className="tootip-img" src={team1} alt="" />
          </Tooltip>
          <Tooltip placement="bottom" title="Arduino">
            <img className="tootip-img" src={team2} alt="" />
          </Tooltip>
          <Tooltip placement="bottom" title="Chuột">
            <img className="tootip-img" src={team3} alt="" />
          </Tooltip>
          <Tooltip placement="bottom" title="Bàn Phím">
  ...
  const timelineList = [
    {
      title: "Máy tính, Chuột - ĐINH VĂN THỨC",
      time: "09 JUN 7:20 PM",
      color: "green"
    },
    {
  ...
  const colors = ["#ff7875", "#ffc069", "#95de64", "#69c0ff", "#d3adf7", "#ff85c0"];
    ...
    <BaseLayout>
      <>
        <div className="layout-content">
          <Row className="rowgap-vbox" gutter={[24, 0]}>
            {count.map((c, index) => (
              <Col key={index} xs={24} sm={24} md={12} lg={6} xl={6} className="mb-24">
                <Card bordered={false} className="criclebox" style={{ backgroundColor: colors[index % colors.length] }}>
          ...
          <Row gutter={[1, 1]}>
            <Col xs={24} sm={24} md={12} lg={12} xl={12} className="mb-24 mr-24">
            ...
            <Col xs={24} sm={24} md={12} lg={12} xl={16} className="mb-24">
              <Card bordered={false} className="criclebox cardbody h-full">
                <div className="project-ant">
                  <div>
                    <Title level={5}>Danh sách đang mượn</Title>
                  </div>
                  <div className="ant-filtertabs">
                    <div className="antd-pro-pages-dashboard-analysis-style-salesExtra">
                      <Radio.Group onChange={onChange} defaultValue="a">
                        <Radio.Button value="a">ĐANG MƯỢN</Radio.Button>
                        <Radio.Button value="b">ĐÃ TRẢ</Radio.Button>
                        <Radio.Button value="c">BẢO TRÌ</Radio.Button>
                      </Radio.Group>
                    </div>
                  </div>
                </div>
            ...
            <Col xs={24} sm={24} md={12} lg={12} xl={8} className="mb-24">
              <Card bordered={false} className="criclebox h-full">
                <div className="timeline-box">
                  <Title level={5}>DANH SÁCH ĐANG ĐẶT</Title>
                  ...
                  <Col xs={24} md={12} sm={24} lg={12} xl={14} className="mobile-24">
                    <div className="h-full col-content p-20">
                      <div className="ant-muse">
                        <Text>Thiết bị mới</Text>
                        <Title level={5}>Máy khử rung tim</Title>
                        <Paragraph className="lastweek mb-36">
                          Máy khử rung tim hiện đại có thiết kế nhỏ gọn, dễ sử dụng và có độ tin cậy cao, là lựa chọn
                          tối ưu cho các bệnh viện và cơ sở y tế.
                        </Paragraph>
                      </div>
